...
vendas_zoop_dyf = glueContext.create_dynamic_frame.from_catalog(database='db-glue-dados', table_name='dados-glue-vendas_zoop_bronze_parquet')
...
s3output = glueContext.getSink(
  path="s3://dados-zoop-cie/silver/vendas/", # adicione o nome do seu bucket no path
  connection_type="s3",
...
s3output.setCatalogInfo(
  catalogDatabase="db-glue-dados", catalogTableName="dados-glue-vendas_zoop_silver"
)
