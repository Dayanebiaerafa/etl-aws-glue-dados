...
estoques_zoop_dyf = glueContext.create_dynamic_frame.from_catalog(database='db-glue-dados', table_name='dados-glue-estoques_zoop_bronze_parquet')
...
s3output = glueContext.getSink(
  path="s3://dados-zoop-cie/silver/estoques/",  # adicione o nome do seu bucket no path
  connection_type="s3",
...
s3output.setCatalogInfo(
  catalogDatabase="db-glue-dados", catalogTableName="dados-glue-estoques_zoop_silver"
)
